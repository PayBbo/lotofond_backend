<template>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" :class="'bkt-fill-'+color"  :width="width" :height="height">
        ...
        <path d="M341,364.8A20,20,0,1,1,320.8,345,20.1,20.1,0,0,1,341,364.8Z" transform="translate(-145 -145)"/>
        <path d="M497,365.1A20,20,0,1,1,477.1,345,20.1,20.1,0,0,1,497,365.1Z" transform="translate(-145 -145)"/>
        <path d="M361.1,577A20,20,0,1,1,381,556.9,20.1,20.1,0,0,1,361.1,577Z" transform="translate(-145 -145)"/>
        <path d="M461,557a20,20,0,1,1-20-20A20.1,20.1,0,0,1,461,557Z" transform="translate(-145 -145)"/>
    </svg>
</template>
