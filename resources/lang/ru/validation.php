...
return [
    ...
    'verification_code' => 'Неправильный код подтверждения.',
    'image_err'=>'Картинка не может быть загружена',
    'file_err'=>'Файл не может быть загружен',
    'export_err'=>'Произошла ошибка при экспорте, попробуйте позже',
    'exceeding_limit'=>'Превышен лимита доступного количества папок',
    'one_note'=>'Заметка уже существует',
    'exists_note'               => 'Выбранная заметка не существует.',
    'exists_event'=> 'Выбранное событие не существует.',
    'credentials_submitted_email'=> 'Необходимо подтвердить действие с действующей почты',
    'credentials_submitted_phone'=> 'Необходимо подтвердить действие с действующего номера телефона',
    'user_password'=>'Пароль не совпадает с паролем аккаунта',
    'new_user_password'=>'Новый пароль не может совпадать с текущим',
    'submit_user_password'=>'Пароли не сопадают',
    'message_err'=>'Сообщение не может быть отправлено, повторите попытку',
    'user_not_found'=>'Неверные данные для авторизации через социальные сети',
    'authorization_required'=>'Вам необходимо зарегистрироваться для получения остального контента',
    'not_enough_credentials'=>'Недостаточно данных в профиле для выбранного действия',
    'payment_error'=> 'Что-то пошло не так, попробуйте еще раз',
    'no_activated_tariff'=>'У Вас не активирован тариф',
    'has_activated_tariff'=>'У Вас уже есть активированный тариф',
