...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "Favourites",
  components: {
    'bkt-select': _components_Select__WEBPACK_IMPORTED_MODULE_1__["default"],
              ...
              _c(
                ...
                _vm._l(_vm.items_paths, function (path) {
                  return _c(
                    "button",
                    {
                      staticClass: "bkt-button bkt-button_plump",
                      class: [
                        _vm.current_path === path.id && path.color
                          ? "bkt-bg-" + path.color
                          : "",
                        {
                          "bkt-bg-primary":
                            _vm.current_path === path.id && !path.color,
                          "bkt-bg-white": _vm.current_path !== path.id,
                        },
                      ],
                    },
                    [
