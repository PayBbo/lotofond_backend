...
class UserResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'tariff'=> $this->user_tariff_id,
            'botTariff'=> $this->bot_tariff_id,
            ...
            'botFinishedAt' => $this->bot_finished_at,
            'botDiffInDays' =>  $this->bot_finished_at ? Carbon::now()->diffInDays($this->bot_finished_at) : null,
            'region'=>!is_null($this->region_id) ? $this->title : null
        ];
    }
}
