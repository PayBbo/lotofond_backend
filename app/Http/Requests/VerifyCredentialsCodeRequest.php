...
class VerifyCredentialsCodeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email' => ['sometimes', 'required', 'email', 'exists:change_credentials,email', new IsUserCredentials],
            'phone' => ['sometimes', 'required', new Phone, 'exists:change_credentials,phone', new IsUserCredentials],
